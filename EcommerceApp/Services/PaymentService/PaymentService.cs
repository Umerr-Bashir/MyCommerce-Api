...
{order.BillingAddress.PresentAddress}<br/>
{(string.IsNullOrWhiteSpace(order.BillingAddress.PermanentAddress) ? "" : order.BillingAddress.PermanentAddress + "<br/>")}
{order.BillingAddress.City}, {order.BillingAddress.State} {order.BillingAddress.PostalCode}<br/>
{order.BillingAddress.Country}
</td>
<td style='width: 50%; vertical-align: top; padding: 8px; border: 1px solid #dddddd;'>
<strong>Shipping Address</strong><br/>
{order.ShippingAddress.PresentAddress}<br/>
{(string.IsNullOrWhiteSpace(order.ShippingAddress.PermanentAddress) ? "" : order.ShippingAddress.PermanentAddress + "<br/>")}
